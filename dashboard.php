...
<html>
  <head>
    ...
    <title>All About Accounting - Redirecting To Exam</title>
  </head>
  ...
  <body>
    ...
    <?php
      ...
      <div class="bg-darkYellow sm:h-16 h-24">
        <div
          class="flex justify-center items-center md:gap-6 gap-3 h-full container sm:flex-row flex-col"
        >
      ...
      <header class="nav w-full left-0 top-0 z-50 lg:py-5 py-2 bg-cyanBlue">
        <div class="container">
          <div class="nav__main flex justify-between items-center">
            <div>
              <a class="flex items-center gap-2" href="../html/home.php">
                <img
                  width="44"
                  height="44"
                  src="../assets/images/AAAlogo.webp"
                  alt=""
                />
                <span class="md:inline hidden text-white font-bold text-lg"
                  >All About Accounting</span
                >
              </a>
            </div>
            ...
            <nav class="nav__menu">
              ...
              <ul class="nav__list flex lg:flex-row flex-col lg:gap-8">
                <li class="nav__item relative">
                  <a
                    class="duration-300 transition ease-in-out hover:text-darkYellow text-[#FFFFFFDE]"
                    href="../html/home.html"
                    >Home</a>
                  >
                </li>
                <li class="nav__item relative">
                  <a
                    class="duration-300 transition ease-in-out hover:text-darkYellow text-[#FFFFFFDE]"
                    href="../html/enroll-now.html"
                    >Enroll Now</a
                  >
                </li>
                <li class="nav__item relative nav__item-child">
                  <a
                    class="duration-300 transition ease-in-out hover:text-darkYellow text-[#FFFFFFDE] !flex gap-2"
                    href="../html/courses.html"
                    data-toggle="nav__dropdown"
                    >Courses
                    <svg
                  ...
                  >
                    <li class="nav__item relative">
                      <a
                        class="duration-300 transition ease-in-out hover:text-darkYellow lg:text-black text-[#FFFFFFDE]"
                        href="../html/cma1demo.html"
                        >CMA PART 1 DEMO</a
                      >
                    </li>
                    <li class="nav__item relative">
                    ...
                    <li class="nav__item relative">
                      <a
                        class="duration-300 transition ease-in-out hover:text-darkYellow lg:text-black text-[#FFFFFFDE]"
                        href="#"
                        >MODERN ACCOUNTING PART 1 DEMO</a>
                      >
                    </li>
                    <li class="nav__item relative">
    ...
    <section class="bg-cyanBlue">
      <div class="flex flex-col justify-center items-center h-[70vh] pt-10">
        <img
          src="../assets/images/AAAlogo.webp"
          class="max-w-[322px] max-h-[322px] h-auto w-full"
        />
        <h1 class="text-white text-center md:text-4xl text-2xl font-bold" href="mcq-quiz.html"> </h1>
      </div>
    </section>
    <!--ALEX UNIV HERE-->
    <!--FOOTER HERE-->
    <footer class="bg-black">
        ...
        <div class="container px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div class="flex justify-center mt-6 space-x-6">
            <a target="_blank" href="https://www.facebook.com/AllAboutAccountingFB" class="text-gray-400 hover:text-darkYellow transition-all duration-300">
            ...
            <a href="https://www.linkedin.com/company/all-about-accounting-institute/" target="_blank" class="text-gray-400 hover:text-darkYellow transition-all duration-300">
            ...
            <a target="_blank" href="https://www.youtube.com/@AAAccounting" class="text-gray-400 hover:text-darkYellow transition-all duration-300">
            ...
            <a href="https://www.instagram.com/aaacounting_com/" target="_blank" class="text-gray-400 hover:text-darkYellow transition-all duration-300">
            ...
            <a href="https://www.tiktok.com/@all_about_accounting" target="_blank" class="text-gray-400 hover:text-darkYellow transition-all duration-300">

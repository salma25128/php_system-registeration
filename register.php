...
<head>
    ...
    <title>All About Accounting - Signup</title>
</head>
...
<body>
                  ...
                  <img class="w-5 h-5" src="../assets/images/login.svg" />
                    ...
                    <nav class="nav__menu">
                        <div class="nav__menu-close">
                            <img src="../assets/images/xicon.svg" alt="close" />
                        </div>
    ...
    <div class="md:flex">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 pt-[200px] md:w-1/2">
            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
              <img class="mx-auto h-20 w-auto" src="../assets/images/AAAlogo.webp" alt="Your Company">
              <h2 class="mt-5 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign up new account !</h2>
            </div>
            ...
            <?php
                    ...
                    ?>
              <form class="space-y-6" action="register-code.php" method="POST">
                    <div>
                        <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Full Name</label>
                        <div class="mt-2">
                          <input id="name" name="name" type="text" autocomplete="name" required class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6"">
                        </div>
                      </div>      
                <div>
                  <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email address</label>
                  <div class="mt-2">
                    <input id="email" name="email" type="email" autocomplete="email" required class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6"">
                  </div>
                </div>
                <div>
                    <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Mobile number</label>
                    <div class="mt-2">
                      <input id="tel" pattern="[0-9]{11}" name="tel" type="tel" autocomplete="tel" required class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6"">
                    </div>
                  </div>
                  <div>
                    <label for="university" class="block text-sm font-medium leading-6 text-gray-900">University</label>
                    <div class="mt-2">
                        <select class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6" name="university" id="university">
                            <option value="American University">AUC (American University)</option>
                            <option value="BUE">BUE (British University)</option>
                            <option value="German University">German University</option>
                            <option value="Arab Academy for Science, Technology & Maritime Transport">Arab Academy for Science, Technology & Maritime Transport</option>
                            ...
                            <option value="Luxor University">Luxor University</option>
                            ...
                            <option value="African Graduate University">African Graduate University</option>
                    ...
                    <div class="mt-2">
                        <select class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6" name="year" id="year">
                ...
                <div>
                  ...
                  <div class="mt-2">
                    <input id="password" name="password" type="password" autocomplete="current-password" required class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6"">
                  </div>
                </div>
                <div>
                    <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Confirm Password</label>
                  <div class="mt-2">
                    <input id="password2" name="password2" type="password" autocomplete="current-password" required class="duration-300 ease-in-out transition block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm focus:outline-none pl-3 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600 sm:text-sm sm:leading-6"">
                  </div>
                </div>
                <div>
                  <button type="submit" name="registerBtn" class="flex w-full justify-center rounded-md bg-cyanBlue px-3 py-1.5 text-sm font-semibold leading-6 text-white duration-300 transition ease-in-out hover:bg-darkYellow shadow-sm hover:text-cyanBlue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create your account</button>
                </div>
          ...
          <div class="w-1/2 md:block hidden">
            <img class="h-full object-cover" src="https://images.unsplash.com/photo-1496917756835-20cb06e75b4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1908&q=80" alt="">    
          </div>
    </div>
          <!--FOOTER HERE-->
